        ...
        <div className="flex flex-col h-full px-8 pt-10 pb-12 gap-0">
          {navLinks.map((link, index) => (
            <Link
              ...
              className="text-foreground/70 hover:text-primary text-base tracking-[0.2em] uppercase py-5 border-b border-border/40 transition-colors duration-200"
          ...
          <div className="mt-auto pt-8 flex flex-col gap-3">
            <Button
              asChild
              className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-none py-6 text-xs tracking-[0.2em] uppercase"
            >
            ...
            <Link
              ...
              onClick={() => setIsMobileMenuOpen(false)}
              className="flex items-center justify-center gap-2 border border-border text-foreground/80 hover:border-primary hover:text-primary rounded-none py-[1.3rem] text-xs tracking-[0.2em] uppercase transition-all duration-300"
            >
